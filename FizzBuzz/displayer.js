...
window.addEventListener('load', function () {
    ...
    function DisplayerInit(){
        ...
        InputCreator('button', 'inputButton', 'FizzBuzz me !', '', divNumber);
        ...
        document.getElementById('inputButton').addEventListener('click', function () {
            ...
            for(i = 1; i <= number; i++){
                ...
                var divNumber = ContainerCreator();
                ResultDisplayer(result, divNumber);
            }
        });
    ...
    function ResultDisplayer(result, divNumber){
        //get the wanted div
        var containerElement = document.body.children.item(divNumber);

        //display result
        containerElement.innerHTML = `n°${divNumber} : ${result}`;
    }
});
